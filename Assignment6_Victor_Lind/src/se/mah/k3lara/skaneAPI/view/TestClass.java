...
public class TestClass {
	...
	public static void main(String[] args) {
		//hämtar 20 instanser av resor mellan malmö c och lund c
		...
		//Hämtar journeys mha searchURL-strängen som innehåller rätt data
		...
		//lägger till resultaten i en arrayList
	    ArrayList<Station> searchStations = new ArrayList<Station>(); 
		//lägger till stationer som innehåller "Malm" i namnet
